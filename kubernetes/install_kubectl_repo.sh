...
do
    ...
    ssh centos@$i -oStrictHostKeyChecking=no -i kp- "bash <(curl -s https://raw.githubusercontent.com/Augugrumi/vagrantfiles/olversion/kubernetes/centos/bootstrap.sh) && sudo reboot" &
